...
<body class="marginbody">
    ...
    <div class="giuatrang">
        <input type="text" id="single-line" class="border" name="single-line" placeholder="&nbsp &nbsp Tìm món" style="width: 400px; height: 40px;">
    </div>
    ...
    <div id="lipton" class="mon_item">
        <div class="texttitle" id="anlipton">
            <p>LIPTON</p>
        </div>
        <div class="marginhinhanh" id="anliptonchitiet">
            ...
            <div>
                ...
                <p class="textmon">Lipton Sửa 15.000</p>
            </div>
        </div>
    </div>
    <!--
    Trà sửa
    <div class="texttitle" id="antrasua">
        <p>TRÀ SỬA</p>
    </div>
    ...
    <div class="texttitle" id="annuocep">
        <p>NƯỚC ÉP</p>
    </div>
    ...
    <div class="texttitle" id="ansinhto">
        <p>SINH TỐ</p>
    </div>
    ...
    <div class="texttitle" id="anbanhtrang">
        <p>BÁNH TRÁNG</p>
    </div>
    ...
    <div class="texttitle" id="ancavien">
        <p>CÁ VIÊN</p>
    </div>
    ...
    <div class="texttitle" id="annuocchai">
        <p>NƯỚC CHAI</p>
    </div>
    ...
    <div class="texttitle" id="antotuong">
        <p>TÔ TƯỢNG</p>
    </div>
